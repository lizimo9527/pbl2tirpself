...
export type SetNavigationBarColorOptions = {
     ...
     * }
     */
    animation?: SetNavigationBarColorOptionsAnimation | null;
}
...
export type ShowNavigationBarLoadingSuccess = AsyncApiSuccessResult
export type ShowNavigationBarLoadingSuccessCallback = (
    result: ShowNavigationBarLoadingSuccess,
) => void
export interface ShowNavigationBarLoadingFail extends IUniError { }
export type ShowNavigationBarLoadingFailCallback = (
    error: ShowNavigationBarLoadingFail,
) => void
export type ShowNavigationBarLoadingOptions = {
    success?: ShowNavigationBarLoadingSuccessCallback
    fail?: ShowNavigationBarLoadingFailCallback
    complete?: () => void
}
export type ShowNavigationBarLoading = (options?: ShowNavigationBarLoadingOptions | null) => void;


export type HideNavigationBarLoadingSuccess = AsyncApiSuccessResult
export type HideNavigationBarLoadingSuccessCallback = (
    result: HideNavigationBarLoadingSuccess,
) => void
export interface HideNavigationBarLoadingFail extends IUniError { }
export type HideNavigationBarLoadingFailCallback = (
    error: HideNavigationBarLoadingFail,
) => void
export type HideNavigationBarLoadingOptions = {
    success?: HideNavigationBarLoadingSuccessCallback
    fail?: HideNavigationBarLoadingFailCallback
    complete?: () => void
}
export type HideNavigationBarLoading = (options?: HideNavigationBarLoadingOptions | null) => void;
...
export interface Uni {
     ...
     *   }
     * }
     * @tutorial_weixin https://developers.weixin.qq.com/miniprogram/dev/api/ui/navigation-bar/wx.setNavigationBarColor.html
     */
     ...
     *   }
     * }
     * @tutorial_weixin https://developers.weixin.qq.com/miniprogram/dev/api/ui/navigation-bar/wx.setNavigationBarTitle.html
     */
 ...
 * }
 */
export type SetNavigationBarColorOptionsAnimation = {
    /**
    * 动画变化时间，单位 ms
    * 
    * @uniPlatform {
