...
export interface Uni {
    /**
     * 使用系统分享。
     * @tutorial https://doc.dcloud.net.cn/uni-app-x/api/share-with-system.html#sharewithsystem
     * @tutorial_uni_app_x https://doc.dcloud.net.cn/uni-app-x/api/share-with-system.html#sharewithsystem
     * @tutorial_uni_app https://uniapp.dcloud.net.cn/api/plugins/share.html#sharewithsystem
