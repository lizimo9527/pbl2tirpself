...
exports.mergeArkTSAutoImports = exports.getArkTSAutoImports = exports.getRuntimePackageName = void 0;
function getRuntimePackageName(isX = false) {
    return isX ? '@dcloudio/uni-app-x-runtime' : '@dcloudio/uni-app-runtime';
}
exports.getRuntimePackageName = getRuntimePackageName;
...
function getArkTSAutoImports(isX = false) {
    ...
    if (isX) {
        ...
        // worker
        ['WorkerTaskImpl'], ['Worker'], ['WorkerPostMessageOptions']);
    }
