...
export declare function genManifestFile(platform: APP_PLATFORM, { files, pluginDir, env, cacheDir, pluginRelativeDir, is_uni_modules, deps, }: GenManifestFileOptions): Promise<boolean>;
export declare function genManifestJson(platform: APP_PLATFORM, { pluginDir, files, env, is_uni_modules, deps }: GenManifestJsonOptions): Promise<Manifest>;
